            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('quizzes.update', $quiz) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ $quiz->description }}</textarea>
                    </div>
