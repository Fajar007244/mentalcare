            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    @foreach ($quizzes as $quiz)
                        <div class="bg-primary-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col">
                            <div class="flex-shrink-0">
                                ...
                                <h4 class="text-xl font-semibold text-primary-800">{{ $quiz->title }}</h4>
                                <p class="text-gray-700 text-sm mt-2 mb-4 flex-grow">{{ $quiz->description }}</p>
                            </div>
                            <div class="mt-auto">
                                <a href="{{ route('quizzes.start', $quiz) }}" class="inline-flex items-center text-primary-600 hover:text-primary-800 font-medium">
                                    Mulai Tes
