<div class="p-6 lg:p-8 bg-white border-b border-gray-200 rounded-lg shadow-md">
    <h1 class="mt-8 text-2xl font-medium text-gray-900">
        Selamat Datang di Dashboard MentalCare, {{ Auth::user()->name }}!
    </h1>
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-primary-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <a href="{{ route('quizzes.index') }}" class="inline-flex items-center text-primary-600 hover:text-primary-800 font-medium">
                Mulai Tes
        ...
        <div class="bg-secondary-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <p class="text-gray-700 text-sm mb-4">Pelajari berbagai topik kesehatan mental.</p>
            <a href="{{ route('courses.index') }}" class="inline-flex items-center text-secondary-600 hover:text-secondary-800 font-medium">
                Lihat Kursus
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-1">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                </svg>
        ...
        <div class="bg-blue-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <a href="{{ route('appointments.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium">
                Buat Janji
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-1">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                </svg>
        ...
        <div class="bg-green-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <a href="{{ route('mood-entries.index') }}" class="inline-flex items-center text-green-600 hover:text-green-800 font-medium">
                Isi Jurnal
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-1">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                </svg>
        ...
        <div class="bg-yellow-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <a href="{{ route('profile.show') }}" class="inline-flex items-center text-yellow-600 hover:text-yellow-800 font-medium">
                Kelola Akun
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-1">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
                </svg>
